...
class RBridge(object):
	...
	def lmer(self, formula, lmerVar='lmer1', pvalsVar='pv1', nsim=1000, \
		...
		full		--	Indicates whether the full model output should be
						returned, or only a subset. (default=False)
		printLmer	--	Indicates whether the LMER output should be printed to
						the stdout. This is a hack, because it's not easy to
						access the lmer output otherwise. (default=False)

		Returns:
		A DataMatrix with the model output, as generated by `pvals.fnc()`.
		"""
